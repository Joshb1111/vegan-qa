    ...
    <div className="reply-helper">
      <div className="reply-header">
        ...
        <p className="reply-sub">
          Paste a comment from social media. You'll get a short reply and a longer one. Pick whichever fits the conversation.
        </p>
      ...
      <div className="reply-input-wrap">
        <textarea
          ...
          placeholder='Paste a comment here — e.g., "But animals exploit other animals too."'
          rows={5}
          maxLength={2000}
          onKeyDown={e => {
