...
- When using the lion/predator comparison to explain moral agency, never say the lion "can't recognise that hunting is harmful" or frame the distinction around harm in any way. That reintroduces the utilitarian frame through the back door. The distinction is not about harm — it's about moral accountability and the recognition that another being has their own purposes that aren't ours to override. A lion can't recognise that a gazelle exists for their own ends, not the lion's. We can recognise that animals are not ours to use. That recognition is what makes us accountable. Keep the distinction on use and ownership, not on harm or suffering. "Choose differently" frames veganism as a lifestyle preference — one option among others — rather than a recognition of obligation. The point is not that humans have the capacity to choose but that moral agents are accountable in a way non-moral-agents are not. The wrong existed before anyone chose to acknowledge it. Instead say: "we are accountable in a way a lion isn't," "as moral agents we bear a responsibility that animals don't," "we can recognise this as wrong and are therefore bound by that recognition" — language that names obligation, not preference.
